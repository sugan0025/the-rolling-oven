...
const CATEGORIES = {
  ...
  cookies: {
    ...
    items: [
      ...
      { name: 'Snickerdoodle Cookies',             image: '/images/products/cookies/Snickerdoodle_cookies.png',             price: 99  },
      ...
      { name: 'Shortbread Cookies',                image: '/images/products/cookies/Shortbread_cookies.png',                price: 89  },
  ...
  croissants: {
    ...
    items: [
      ...
      { name: 'Prosciutto Gruyère Croissant', image: '/images/products/croissants/Prosciutto_Grue`re_Croissant.png', price: 239 },
    ],
  },
};
