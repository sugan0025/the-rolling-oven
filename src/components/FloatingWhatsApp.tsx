...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="floating-whatsapp" id="floating-whatsapp-widget">
      <a
        href={`https://wa.me/${whatsappNumber}?text=${defaultMessage}`}
        target="_blank"
        rel="noopener noreferrer"
        className="floating-whatsapp-btn"
        aria-label="Chat with The Rolling Oven on WhatsApp"
      ...
      <span className="floating-whatsapp-tooltip">Order on WhatsApp 💬</span>
    </div>
  );
}
